...
use Botble\Ecommerce\Http\Requests\ProductPropertyRequest;
use Botble\Ecommerce\Models\ProductProperty;
use Illuminate\Support\Arr;

class ProductPropertyForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $this
            ->setupModel(new ProductProperty)
            ->setValidatorClass(ProductPropertyRequest::class)
            ->withCustomFields()
            ->add('name', 'text', [
